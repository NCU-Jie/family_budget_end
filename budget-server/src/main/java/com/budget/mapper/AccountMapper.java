...
public interface AccountMapper {
    ...
    @Select("insert into account(category_id,member_id,money,description,create_time,update_time,create_user,update_user,type_id,family_id,member_name,record_date) values (#{categoryId},#{memberId},#{money},#{description},#{createTime},#{updateTime},#{createUser},#{updateUser}, #{typeId},#{familyId},#{memberName}, #{recordDate})")
